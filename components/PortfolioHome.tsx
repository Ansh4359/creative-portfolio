    ...
    return (
        <>
            ...
            <main className="max-w-4xl mx-auto px-6 pt-12 md:pt-40 pb-6 relative z-10">
                ...
                {/* --- HERO / ABOUT SECTION --- */}
                <section id="about" className="relative mb-16 scroll-mt-32">
                ...
                {/* --- WORK EXPERIENCE --- */}
                <section id="work" className="relative mb-16 scroll-mt-32">
...
const SocialDock = () => {
    ...
    const socialLinks = [
        { icon: XIcon, label: "Twitter", href: "https://x.com/anshsingh4359" },
        { icon: LinkedInIcon, label: "LinkedIn", href: "https://www.linkedin.com/in/ansh01/" },
        { icon: GmailIcon, label: "Email", href: "mailto:anshsingh4359@gmail.com" },
        { icon: Github, label: "GitHub", href: "https://github.com/ansh4359" }
    ];
                                ...
                                >
                                    {link.label === 'Email' ? (
                                        <div className="flex items-center gap-2 group/tooltip">
                                            <span>anshsingh4359@gmail.com</span>
